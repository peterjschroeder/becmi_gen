...
def genpdf(args):
	...
	# FIXME: I moved this out of the loop because it wouldn't work past 50 NPCs. Seems to be working now.
	import os
	import sys
	# FIXME: Remove interaction=batchmode until everything is fixed
#	os.system("pdflatex --interaction=batchmode npc.tex")
	os.system("pdflatex npc.tex")
